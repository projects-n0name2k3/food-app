    ...
    return (
        <div className='max-w-[1240px] mx-auto flex justify-between items-center p-4'>
            ...
            <div className='flex items-center'>
                <div onClick={handleShowNav} className='cursor-pointer'>
            ...
            <div className='bg-gray-200 rounded-full flex items-center px-2 w-[200px] sm:w-[400px] lg:w-[500px]'>
                ...
                <input className='bg-transparent p-2 focus:outline-none w-full' type="text" placeholder='Search Foods' name="" id="" />
            </div>
            {/*Cart button*/}
            ...
            <div className={nav ? 'fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300 ' : 'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300 '}>
                <AiOutlineClose onClick={handleShowNav} size={30} className='absolute right-4 top-4 cursor-pointer' />
